...
# Reason for update:
#   Leaving a basic GUI (v1.2) for anyone who would ever need it for the same/similar project.
...
class Application(Frame):
    ...
    def buttonPress(self, direction, speed, event=None):
        if direction == UP:
            ...
            self.setStatusText("Spinning right (clockwise)")
